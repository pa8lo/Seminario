...
module.exports.bootstrap = async function(done) {
  ...
  await Rol.create({
   ...
   await User.create(
     {id:1 ,Dni: '35111111', Name: 'Admin',LastName:'Test',Password:'123456',Authorizations:[1,2,3,4,5,6,7,8,9],Rols:1,});
   ...
   await Permiso.create({id:9 ,Name:'Edit',Description:'Permite ver usuario',Type:'Usuario',User:1});
