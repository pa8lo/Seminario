...
module.exports = {
    ...
    updateAsisst: async function (req, res) {
      try {
        ...
        let fechacompletasalida = new Date(horasalida[0],fechasalida[1]-1,fechasalida[0],horaParseadasalida[0].trim()-3,horaParseadasalida[1],horaParseadasalida[2],horaParseadasalida[3])
        sails.log.info(fechacompleta);
        let datos = {
